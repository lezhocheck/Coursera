...
void TestsMyCustom()
{
...

    {
        ...
        Date pair1(2019, 12, 3);
        string pair2 = "f";

        AssertEqual(make_pair(pair1, pair2), db.Last({2019, 12, 4}), " My test 6");
        ...
        Date pair3(2019, 12, 2);
        string pair4 = "c c";

        AssertEqual(make_pair(pair3, pair4), db.Last({2019, 12, 2}), " My test 7");

        Date pair5(2019, 12, 3);
        string pair6 = "f";

        AssertEqual(make_pair(pair5, pair6), db.Last({2019, 12, 4}), " My test 8");

        Date pair7(2019, 12, 3);
        string pair8 = "m";

        db.Add({2019, 12, 3}, "m");
        AssertEqual(make_pair(pair7, pair8), db.Last({2019, 12, 3}), " My test 9");
...

    {
        ...
        Date pair1(2019, 12, 1);
        string pair2 = "c";

        AssertEqual(make_pair(pair1, pair2), db.Last({2019, 12, 1}), " My test 20");

        db.Add({2019, 12, 1}, "b");

        Date pair3(2019, 12, 1);
        string pair4 = "c";

        AssertEqual(make_pair(pair3, pair4), db.Last({2019, 12, 1}), " My test 21");
...
void TestDatabase() {
    ...
    // Last
    {
        ...
        Date pair1(2018, 12, 22);
        string pair2 = "e2";

        AssertEqual(db.Last(d), make_pair(pair1, pair2), "Db Last 1");
        Date d3(2018, 12, 24);
        db.Add(d3, "e3");

        Date pair3(2018, 12, 24);
        string pair4 = "e3";

        AssertEqual(db.Last(d), make_pair(pair3, pair4), "Db Last 2");
        ...
        Date pair5(2018, 12, 22);
        string pair6 = "e2";

        AssertEqual(db.Last(d), make_pair(pair5, pair6), "Db Last 4");

        Date pair7(2019, 1, 2);
        string pair8 = "e1";

        AssertEqual(db.Last(d1), make_pair(pair7, pair8), "Db Last 5");
        db.Add(d2, "e4");

        Date pair9(2018, 12, 22);
        string pair10= "e4";

        AssertEqual(db.Last(d2), make_pair(pair9, pair10), "Db Last 6");
    }
